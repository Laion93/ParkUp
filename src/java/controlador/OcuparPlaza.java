...
public class OcuparPlaza extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		if(sesion!=null){
                    ...
                    int numeroPlaza = Integer.parseInt((String) sesion.getAttribute("numeroPlaza"));
                    ...
                    if(p.getTipoVehiculo().equals(v.getTipoVehiculo()) && p.isElectrico() == false){
                        ...
                        String error1 = "El vehiculo elegido no es valido para la plaza seleccionada.";
                        response.sendRedirect("reservaPlaza.jsp?error="+error1);
                    }
		}else{
