...
public class Login extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
			...
			response.sendRedirect("Plazas");
                        ...
                        request.setAttribute("mensajeError","¡Ha introducido un email o contraseña incorrectos!");
			RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/login.jsp?error");
